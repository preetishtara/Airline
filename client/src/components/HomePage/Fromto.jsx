  ...
  return (
    <Fromtocss>
      <div className="fromtodiv">
        <div>
          <h3 className="pt-3 mb-2">FROM</h3>
      ...
      <div className="fromtodiv2">
        <div>
          <h3 className="pt-3 mb-2">DEPARTURE</h3>
          <input type="date" className="date" />
        </div>
        <div>
          <h3 className="pt-3 mb-2">RETURN</h3>
          <input placeholder="choose it" type="date" className="date" />
        </div>
        <div>
          <h3 className="pt-3 mb-2">TRAVLLER & CLASS</h3>
          <select name="" id="">
